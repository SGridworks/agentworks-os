/**
 * Migration 0039 - native AWOS automations.
 *
 * Stores first-party workflow definitions and run history inside the local
 * AgentWorks database so automations do not depend on GitHub Actions or n8n.
 */

import type { Database } from "better-sqlite3";

const HASH = "v39-native-automations";

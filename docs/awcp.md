...
**Schema source:** [`packages/shared/src/schema/action.ts`](https://github.com/SGridworks/agentworks-os/blob/v0.1.4/packages/shared/src/schema/action.ts)
**Policy engine types:** [`packages/policy-engine/src/types.ts`](https://github.com/SGridworks/agentworks-os/blob/v0.1.4/packages/policy-engine/src/types.ts)

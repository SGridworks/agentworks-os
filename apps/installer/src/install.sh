...
#   curl -fsSL https://github.com/SGridworks/agentworks-os/releases/download/v0.1.0/install.sh | bash -s -- --unattended
#
...
# Pin asset fetches to the release tag so v0.1.0 installer cannot silently
